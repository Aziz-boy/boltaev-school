...
const testimonials: TestimonialProps[] = [
  {
    ...
    comment:
      "Boltaev School o'quv markazi yuqori malakali o'qituvchilar va innovatsion metodlar bilan ta'lim berib, talabalarning huquqshunoslik va tarix sohalarida yuqori natijalarga erishishlariga yordam beradi.",
  },
  {
    image:
    ...
    comment:
      "Boltaev School innovatsion yondashuv va malakali o'qituvchilar bilan ta'lim sohasida yangi standartlar o'rnatmoqda.",
  },
  {
    image:
    ...
    comment:
      "Boltaev Schoolda o‘qish juda qulay, o‘qituvchilar ham juda malakali. Darslar juda aniq va tushunarli bo‘ladi, har doim yordamlashishadi!",
  },
  {
    image:
    ...
    comment:
      "Boltaev Schoolning test tuzib beradigan botidan juda mamnunman. Tez va oson test yaratish imkoniyati beradi, darslarga tayyorlanish juda qulay!",
  },
  {
    image:
  ...
  {
    image: "https://i.ibb.co/5WmyYgM3/telegram-cloud-photo-size-2-5226488717332573174-c.jpg",
    name: "Javohir Oromov",
    userName: "TATU",
    comment:
      "Тестовый генератор от Boltaev School — очень полезный инструмент. Идеальное средство для быстрого создания тестов и подготовки к занятиям!",
  },
];
  ...
  return (
    <section id="testimonials" className="container py-24 sm:py-32">
      ...
      <p className="text-xl text-muted-foreground pt-4 pb-8">
        Boltaev Kurs Centeri talabalari va mijozlarining fikrlari asosida
